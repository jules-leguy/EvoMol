...
class GeneratedIndividualsRecorder:
    ...
    def record_individual(self, individual, total_score, objective_calls, improver):
...
class PopAlg:
    ...
    def __init__(self, evaluation_strategy, mutation_strategy, stop_criterion_strategy,
        ...
        :parameter external_tabu_list: list of SMILES that cannot be generated by EvoMol
        :parameter record_all_generated_individuals: whether to record all individuals that are generated in a file
        along with the number of calls to the objective function at the time of insertion.
        """
